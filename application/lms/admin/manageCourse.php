    ...
    $(document).ready(function() {
        ...
        var table1 = $('#courseTabel').DataTable({
            ...
            "columns": [
                ...
                { "data": "year" },
                {   "data": null,
                    "defaultContent": updateButton + removeButton
                }
            ]
        ...
        table1.on("click","." + ajaxRemoveButton,function(){
            ...
            if(confirm("Do you really want to remove This cours ?" + rowData["title"])){
                var thisRow = $(this).parents('tr');
                ajaxSend("id="+ rowData["courseID"],"deleteCourse",thisRow);
            }
        });
